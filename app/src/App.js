 ...
 */
  ...
  return (
    <div className="App">
      ...
      <div style={{
        position: 'fixed', top: 20, left: 20, width: '350px', height: '380px', backgroundColor: 'rgba(0, 0, 0, 0.1)',
      ...
      <div style={{
        position: 'fixed', top: '40%', left: 20, width: '300px', height: '500px', backgroundColor: 'rgba(0, 0, 0, 0.02)',
        boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.5)',  // Drop shadow
        borderRadius: '20px',                         // Curved edges
        fontFamily: 'Perpetua',  // Setting the font family
